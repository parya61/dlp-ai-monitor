...
Проект использует **MLflow** для отслеживания экспериментов ML.

**Что отслеживается:**
- Параметры моделей (learning_rate, depth, iterations)
- Метрики (accuracy, F1-score, recall)
- Сохранённые модели
...
**Триггеры:** Автоматически при каждом `git push`
